-- ============================================================
-- Migration 014 : Exclure le créateur de son propre feed
-- ============================================================
...
BEGIN
  ...
  SELECT row_to_json(t) FROM (
    ...
    WHERE h.status = 'open'
      ...
      -- Exclure les randos créées par l'utilisateur
      AND (current_user_id IS NULL OR h.creator_id != current_user_id)
      -- Exclure les randos où l'utilisateur participe déjà
      AND (
